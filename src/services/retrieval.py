...
from src.models.schemas import Citation, User
from src.rag.local_retriever import has_keyword_overlap, keyword_score
from src.services.llm import cosine_similarity, embed_query_text, has_meaningful_sparse_overlap
...
def search_policy_chunks(query: str, user: User, limit: int = TOP_K) -> list[Citation]:
    from src.services.documents import list_chunks, query_chunks
...
def user_has_readable_chunks(user: User) -> bool:
    from src.services.documents import list_chunks
