...
def _rerank_candidates(query: str, candidates: list[HybridCandidate], limit: int) -> list[HybridCandidate]:
    ...
    if "luong" in normalized_query or "salary" in normalized_query:
        candidates = [
            c for c in candidates
            if "luong" in c.chunk.excerpt.lower()
            or "salary" in c.chunk.excerpt.lower()
            or "luong" in c.chunk.document_title.lower()
            or "salary" in c.chunk.document_title.lower()
        ]
