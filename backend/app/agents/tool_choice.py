...
async def choose_tool_for_state(state: AgentState) -> ToolChoice:
    ...
    if model_choice is not None:
        ...
        if model_choice.tool_name == "get_hr_metrics" and not should_call_hris_tool(query):
            return rule_choice.model_copy(update={"fallback_reason": "model_hris_rejected_without_self_reference"})
